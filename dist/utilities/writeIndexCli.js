...
var _default = function _default(directoryPaths) {
  ...
  if (options.updateIndex || options.recursive) {
    sortedDirectoryPaths = _lodash.default.map(sortedDirectoryPaths, dir => {
      return (0, _findIndexFiles.default)(dir, {
  ...
  _lodash.default.forEach(sortedDirectoryPaths, directoryPath => {
    ...
    const config = (0, _readIndexConfig.default)(directoryPath);
    ...
    const indexFilePath = _path.default.resolve(directoryPath, 'index.js');
